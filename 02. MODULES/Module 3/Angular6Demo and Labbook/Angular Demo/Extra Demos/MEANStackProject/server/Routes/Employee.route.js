...
//By router handler i mean to not just providing routing to our app 
//but also can extend this routing to handle validation

// Employee module which is required and imported
let employeeModel = require('../model/Empolyee');
