...
@Component({
  selector: 'app-attributeng-style-ex',
  templateUrl: './attributeng-style-ex.component.html',
  styleUrls: ['./attributeng-style-ex.component.css']
})
export class AttributengStyleExComponent implements OnInit {
